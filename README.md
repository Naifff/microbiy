...
> Открыть эту страницу в [https://naifff.github.io/microbiy/](https://naifff.github.io/microbiy/)
...
* найдите **https://github.com/naifff/microbiy** и импортируйте

## Править этот проект ![Значок статуса сборки](https://github.com/naifff/microbiy/workflows/MakeCode/badge.svg)

Редактировать этот репозиторий в MakeCode.

* открыть [https://makecode.microbit.org/](https://makecode.microbit.org/)
* нажмите на **Импорт**, затем **Импорт URL**
* вставьте **https://github.com/naifff/microbiy** и нажмите Импорт
...
![Отрисовка в виде блоков](https://github.com/naifff/microbiy/raw/master/.github/makecode/blocks.png)
